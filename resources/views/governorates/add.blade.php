            ...
            <div class="col-md-12 ">
                <div class="card card-primary">
                    <div class="card-header">
                        ...
                        <h3 class="card-title ">محافظات الدول</h3>
                    </div>
                    <form class="card-body" style="display: block;" action="{{route('governorates_addDone')}}" method="post">
                        @csrf
                        @if(isset($select))
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" required name="name" class="form-control" placeholder="ادخل اسم المحافظة">
                        </div>
                        @error('name')
                        <blockquote class="quote-danger">
                            <p style="color: #dc3545"> {{$message}}</p>
