...
@section('title')
    انواع جنسيات الموظفين
@endsection

@section('nationalitys_index')
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark"> انواع جنسيات الموظفين</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{route('index')}}">الرئسية</a></li>
                            <li class="breadcrumb-item active">قائمة جنسيات الموظفين</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <a class="btn btn-outline-secondary col-12" href="{{route('nationalitys_add')}}">اضافة نوع جديدة</a>
                <div class="card card-gray">
                    <div class="card-header">
                        ...
                        <h3 class="card-title ">قائمة جنسيات الموظفين</h3>
                    </div>
                    <div class="card">
                        <input type="text" id="search" name="name" class="form-control" placeholder="ابحث عن  جنسيات الموظفين">
                            ...
                            <table class="table table-striped projects">
                                ...
                                <tr>
                                    ...
                                    <td class="project-actions text-center">
                                        <a class="btn btn-primary btn-sm isActive"  href="{{route('nationalitys_active',$conn->id)}}" >
                                            @if($conn->active == 1)
                                        ...
                                        <a class="btn btn-info btn-sm"  href="{{route('nationalitys_edit',$conn->name)}}">
                                            <i class="fas fa-pencil-alt"></i>
                                        </a>
                                        <a class="btn btn-danger btn-sm delete"  href="{{route('nationalitys_delete',$conn->id)}}">
