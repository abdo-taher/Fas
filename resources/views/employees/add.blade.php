    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">اضافة موظف جديد</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
...
<form action="{{route('employees_addDone')}}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="col-md-12">
        <div class="card">
                    ...
                    <div  class="tab-pane active" id="personal_data">
                        <div class="row" >
                            <div class="form-group col-md-8">
                                ...
                                <input name="emp_name" type="text" class="form-control" value="{{old('emp_name')}}" >
                                @error('emp_name')
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input name="fingerprint_code" type="text" class="form-control" value="{{old('fingerprint_code')}}" >
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <select name="emp_gender" class="form-control select2 select2-hidden-accessible" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                    ...
                                    <option {{old('emp_gender')== 2 ?'selected' : ''}} value="2">انثي</option>
                            ...
                            <div class="form-group col-md-3" >
                                ...
                                @if(isset($allData['marital_status']))
                                        @foreach($allData['marital_status'] as $var)
                                            <option {{old('marital_status_id') == $var->id ? 'selected' : ''}} value="{{$var->id}}">{{$var->name}}</option>
                                        @endforeach
                                    @endif
                                </select>
                                ...
                                <select name="qualif_type_id" id="qualif_type_id" class="form-control select2 select2-hidden-accessible" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                    ...
                                    @if(isset($allData['qualif_type']))
                                        @foreach($allData['qualif_type'] as $var)
                                            <option {{old('qualif_type_id') == $var->id ? 'selected' : ''}} value="{{$var->id}}">{{$var->name}}</option>
                                        @endforeach
                                    @endif
                                </select>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input name="Graduation_specialization" type="text" class="form-control" value="{{old('Graduation_specialization')}}" >
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input name="Qualifications_year" type="date" class="form-control" value="{{old('Qualifications_year')}}" >
                                ...
                                <select name="graduation_estimate_id" class="form-control select2 select2-hidden-accessible" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                    ...
                                    @if(isset($allData['graduation_estimates']))
                                        @foreach($allData['graduation_estimates'] as $var)
                                            <option {{old('graduation_estimate_id') == $var->id ? 'selected' : ''}} value="{{$var->id}}">{{$var->name}}</option>
                                        @endforeach
                                    @endif
                                </select>
                                @error('Qualifications_year')
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input name="brith_date" type="date" class="form-control" value="{{old('brith_date')}}">
                                @error('brith_date')
                                    <div class="form-control bg-danger text-center">{{$message}}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input name="emp_national_idenity" type="number" class="form-control" value="{{old('emp_national_idenity')}}" >
                                @error('Qualifications_year')
                                    <div class="form-control bg-danger text-center">{{$message}}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input name="emp_identityPlace" type="text" class="form-control" value="{{old('emp_identityPlace')}}" >
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input name="emp_end_identityIDate" type="date" class="form-control" value="{{old('emp_end_identityIDate')}}" >
                            ...
                            <div class="form-group col-md-3">
                                ...
                                @if(isset($allData['blood_types']))
                                        @foreach($allData['blood_types'] as $var)
                                            <option {{old('blood_type_id') == $var->id ? 'selected' : ''}} value="{{$var->id}}">{{$var->name}}</option>
                                        @endforeach
                                    @endif
                                </select>
                                @error('blood_type_id')
                                ...
                                <select name="emp_nationality_id" class="form-control select2 select2-hidden-accessible" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                    ...
                                    @if(isset($allData['nationalitys']))
                                        @foreach($allData['nationalitys'] as $var)
                                            <option {{old('emp_nationality_id') == $var->id ? 'selected' : ''}} value="{{$var->id}}">{{$var->name}}</option>
                                        @endforeach
                                    @endif
                                </select>
                                ...
                                <select name="religion_id" class="form-control select2 select2-hidden-accessible" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                    ...
                                    @if(isset($allData['religions']))
                                        @foreach($allData['religions'] as $var)
                                            <option {{old('religion_id') == $var->id ? 'selected' : ''}} value="{{$var->id}}">{{$var->name}}</option>
                                        @endforeach
                                    @endif
                                </select>
                                @error('religion_id')
                            ...
                            <div class="form-group col-md-3" >
                                ...
                                <input name="residence_address" type="text" class="form-control" value="{{old('residence_address')}}" >
                                ...
                                <select name="country_id" id="country_id" class="form-control select2 select2-hidden-accessible" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                    ...
                                    @if(isset($allData['countrys']))
                                        @foreach($allData['countrys'] as $var)
                                            <option {{old('country_id') == $var->id ? 'selected' : ''}} value="{{$var->id}}">{{$var->name}}</option>
                                        @endforeach
                                    @endif
                                </select>
                                @error('country_id')
                                ...
                                @if(old('governorate_id'))
                                    @if($allData['governorates'])
                                        @foreach($allData['governorates'] as $var)
                                            @if($var->id ==old('governorate_id'))
                                            <option {{old('governorate_id') == $var->id ? 'selected' : ''}} value="{{$var->id}}">{{$var->name}}</option>
                                            @endif
                                        @endforeach
                                    @endif
                                @endif
                            ...
                            <div class="form-group col-md-6" >
                                ...
                                <input name="emp_email" type="email" class="form-control" value="{{old('emp_email')}}" >
                                @error('emp_email')
                                    <div class="form-control bg-danger text-center">{{$message}}</div>
                                @enderror
                            </div>
                            <div class="form-group col-md-3" >
                                ...
                                <input name="emp_work_tel" type="tel" class="form-control" value="{{old('emp_work_tel')}}">
                                @error('emp_work_tel')
                                    <div class="form-control bg-danger text-center">{{$message}}</div>
                                @enderror
                            </div>
                            <div class="form-group col-md-3" >
                                ...
                                <input name="emp_home_tel" type="tel" class="form-control" value="{{old('emp_home_tel')}}">
                                @error('emp_home_tel')
                                    <div class="form-control bg-danger text-center">{{$message}}</div>
                                @enderror
                            </div>
                                ...
                                <select name="military_services_id" id="military_service_id" class="form-control select2 select2-hidden-accessible" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                    ...
                                    @if(isset($allData['military_services']))
                                        @foreach($allData['military_services'] as $var)
                                            <option {{old('military_services_id') == $var->id ? 'selected' : ''}} value="{{$var->id}}">{{$var->name}}</option>
                                        @endforeach
                                    @endif
                                </select>
                            ...
                            <div id="one" class="col-md-12 row">
                                <div class="form-group col-md-4" >
                                    ...
                                    <input name="emp_military_date_from" type="date" class="form-control" value="{{old('emp_military_date_from')}}">
                                ...
                                <div class="form-group col-md-4" >
                                    ...
                                    <input name="emp_military_date_to" type="date" class="form-control" value="{{old('emp_military_date_to')}}">
                                ...
                                <div class="form-group col-md-4" >
                                    ...
                                    <input name="emp_military_wepon" type="text" class="form-control" value="{{old('emp_military_wepon')}}">
                            ...
                            <div id="two" class="col-md-12 row">
                                <div class="form-group col-md-6" >
                                    ...
                                    <input name="exemption_date" type="date" class="form-control" value="{{old('exemption_date')}}">
                                ...
                                <div class="form-group col-md-6" >
                                    ...
                                    <input name="exemption_reason" type="text" class="form-control" value="{{old('exemption_reason')}}">
                            ...
                            <div id="three" class="col-md-12 row" >
                                <div class="form-group col-md-6" >
                                    ...
                                    <input name="emp_delay_date_from" type="date" class="form-control" value="{{old('emp_delay_date_from')}}">
                                ...
                                <div class="form-group col-md-6" >
                                    ...
                                    <input name="emp_delay_date_to" type="date" class="form-control" value="{{old('emp_delay_date_to')}}">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <select name="does_has_Driving_License" id="check_driving_licenses" class="form-control select2 select2-hidden-accessible" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                    <option {{old('does_has_Driving_License') == 1 ? 'selected' : ''}} value="1">لا</option>
                                    <option {{old('does_has_Driving_License') == 2 ? 'selected' : ''}} value="2">نعم</option>
                                </select>
                            ...
                            <div id="driving_licenses_yes" class="col-md-12 row">
                                <div class="form-group col-md-6" >
                                    ...
                                    <input name="driving_License_degree" type="number" class="form-control" value="{{old('driving_License_degree')}}">
                                    ...
                                    <select name="driving_license_id" id="does_has_Driving_License" class="form-control select2 select2-hidden-accessible" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                        @if(isset($allData['driving_licenses']))
                                            @foreach($allData['driving_licenses'] as $var)
                                                <option {{old('driving_license_id') == $var->id ? 'selected' : ''}} value="{{$var->id}}">{{$var->name}}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <select name="has_Relatives" id="has_Relatives" class="form-control select2 select2-hidden-accessible" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                    <option {{old('has_Relatives') == 1 ? 'selected' : ''}} value="1">لا</option>
                                    <option {{old('has_Relatives') == 2 ? 'selected' : ''}} value="2">نعم</option>
                                </select>
                                @error('has_Relatives')
                                    <div class="form-control bg-danger text-center">{{$message}}</div>
                                @enderror
                            ...
                            <div id="has_Relatives_yes" class="col-md-8 row">
                                <div class="form-group col-md-12" >
                                    ...
                                    <input name="Relatives_details" type="text" class="form-control" value="{{old('Relatives_details')}}">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <select name="is_Disabilities_processes" id="is_Disabilities_processes" class="form-control select2 select2-hidden-accessible" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                    <option {{old('is_Disabilities_processes') == 1 ? 'selected' : ''}} value="1">لا</option>
                                    <option {{old('is_Disabilities_processes') == 2 ? 'selected' : ''}} value="2">نعم</option>
                                </select>
                                    ...
                                    <select name="Disabilities_processes_id" id="Disabilities_processes_id" class="form-control select2 select2-hidden-accessible" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                        @if(isset($allData['disabilities_processes']))
                                            @foreach($allData['disabilities_processes'] as $var)
                                                <option {{old('Disabilities_processes_id') == $var->id ? 'selected' : ''}}  value="{{$var->id}}">{{$var->name}}</option>
                                            @endforeach
                                        @endif
                                    </select>
                    ...
                    <div  class="tab-pane" id="functional_data">
                        <div class="row" >
                            <div class="form-group col-md-3">
                                ...
                                <input name="emp_start_date" type="date" class="form-control" value="{{old("emp_start_date")}}">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <select name="Functiona_status" class="form-control select2 select2-hidden-accessible" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                    <option {{old('Functiona_status') == 1 ? 'selected' : ''}} value="1">قائم باالعمل</option>
                                    <option {{old('Functiona_status') == 2 ? 'selected' : ''}} value="2">خارج الخدمة</option>
                                </select>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <select name="does_has_ateendance" class="form-control select2 select2-hidden-accessible" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                    <option {{old('does_has_ateendance') == 1 ? 'selected' : ''}} value="1">نعم</option>
                                    <option {{old('does_has_ateendance') == 2 ? 'selected' : ''}} value="2">لا</option>
                                </select>
                                ...
                                <select name="branch_id" class="form-control select2 select2-hidden-accessible" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                    ...
                                    @if(isset($allData['branches']))
                                        @foreach($allData['branches'] as $var)
                                            <option {{old('branch_id') == $var->id ? 'selected' : ''}} value="{{$var->id}}">{{$var->name}}</option>
                                        @endforeach
                                    @endif
                                </select>
                                @error('branch_id')
                                ...
                                <select name="emp_Departments_id" id="emp_Departments_id" class="form-control select2 select2-hidden-accessible" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                    ...
                                    @if(isset($allData['departements']))
                                        @foreach($allData['departements'] as $var)
                                            <option {{old('emp_Departments_id') == $var->id ? 'selected' : ''}} value="{{$var->id}}">{{$var->name}}</option>
                                        @endforeach
                                    @endif
                                </select>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input name="emp_sal" type="number" class="form-control" value="{{old('emp_sal')}}" >
                                @error('emp_sal')
                                    <div class="form-control bg-danger text-center">{{$message}}</div>
                                @enderror
                            </div>
                            <div  class="form-group col-md-3 " >
                                ...
                                <select name="sal_cach_or_visa" class="form-control select2 select2-hidden-accessible" id="sal_cach_or_visa" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                    <option {{old("sal_cach_or_visa") == 1 ? 'selected' : ''}} value="1">نقدي </option>
                                    <option {{old("sal_cach_or_visa") == 2 ? 'selected' : ''}} value="2">كاش</option>
                                </select>
                            ...
                            <div class="form-group col-md-3" >
                                ...
                                <select name="shift_type" class="form-control select2 select2-hidden-accessible"  id="shift_type" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                    <option {{old("shift_type") == 1 ? 'selected' : ''}} value="1">شفت ثابت</option>
                                    <option {{old("shift_type") == 2 ? 'selected' : ''}} value="2">شفت متغير</option>
                                </select>
                                @error('shift_type')
                                <div class="form-control bg-danger text-center">{{$message}}</div>
                                @enderror
                            ...
                            <div  id="shift_type_id" class="form-group col-md-3" hidden>
                                <label>نوع الشفت</label>
                                    ...
                                    @foreach($allData['shitfts_type'] as $var)
                                            <option {{old('shift_type_id') == $var->id ? "selected" : '' }} value="{{$var->id}}">{{$var->shift_detalis($var->id)}}</option>
                                        @endforeach
                                    </select>
                                    @endif
                            </div>
                            <div class="form-group col-md-3" >
                                ...
                                <select name="MotivationType" class="form-control select2 select2-hidden-accessible" id="motivationType" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                    <option {{old("MotivationType") == 1 ? 'selected' : ''}} value="1">ثابت </option>
                                    <option {{old("MotivationType") == 2 ? 'selected' : ''}} value="2">متغير</option>
                                </select>
                            ...
                            <div id="Motivation_view" class="form-group col-md-3 " >
                                ...
                                <input name="Motivation" type="number" class="form-control" value="{{old('Motivation')}}">
                                @error('Motivation')
                                    <div class="form-control bg-danger text-center">{{$message}}</div>
                                @enderror
                            </div>
                            <div id="ismedicalinsurance" class="form-group col-md-6 " >
                                ...
                                <select name="ismedicalinsurance" class="form-control select2 select2-hidden-accessible" id="ismedicalinsurance" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                    <option {{old("ismedicalinsurance") == 1 ? 'selected' : ''}} value="1">نعم </option>
                                    <option {{old("ismedicalinsurance") == 2 ? 'selected' : ''}} value="2">لا</option>
                                </select>
                            ...
                            <div id="medicalinsurancecutmonthely" class="form-group col-md-6 " >
                                ...
                                <input name="medicalinsurancecutmonthely" type="number" class="form-control" value="{{old('medicalinsurancecutmonthely')}}" >
                            ...
                            <div class="form-group col-md-4 "  >
                                ...
                                <select name="is_active_for_Vaccation" class="form-control select2 select2-hidden-accessible" id="is_active_for_Vaccation" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                    ...
                                    <option {{old("is_active_for_Vaccation") == 2 ? 'selected' : ''}} value="2">لا</option>
                                </select>
                            ...
                            <div id="Annual_leave_balance" class="form-group col-md-4 " >
                                ...
                                <input name="Annual_leave_balance" type="number" class="form-control" value="{{old('Annual_leave_balance')}}">
                            ...
                            <div  class="form-group col-md-4 " >
                                ...
                                <select name="Does_have_fixed_allowances" class="form-control select2 select2-hidden-accessible" id="Does_have_fixed_allowances" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                    <option {{old() == 1 ? 'selected' : ''}} value="1">نعم </option>
                                    <option {{old() == 2 ? 'selected' : ''}} value="2">لا</option>
                                </select>
                            ...
                            <div  class="form-group col-md-4 " >
                                ...
                                <input name="date_of_being_hired" type="date" class="form-control" value="{{old('date_of_being_hired')}}">
                    ...
                    <div  class="tab-pane" id="additional_data">
                        <div class="row">
                            ...
                            <div class="col-md-12 row">
                                <div class="form-group col-md-12">
                                    ...
                                    <select name="is_forgin" class="form-control select2 select2-hidden-accessible" id="nationality_poll" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                        <option {{old("is_forgin") == 1 ? 'selected' : ''}} value="1" >نعم</option>
                                        <option {{old("is_forgin") == 2 ? 'selected' : ''}} value="0" >لا</option>
                                    </select>
                                    @error('is_forgin')
                                    <div class="form-control bg-danger text-center">{{$message}}</div>
                                @enderror
                                ...
                                <div class="row col-md-12" id="poll_request" >
                                    <div class="form-group col-md-3">
                                        ...
                                        <input name="emp_cafel" type="text" class="form-control" value="{{old('emp_cafel')}}">
                                        @error('emp_cafel')
                                            <div class="form-control bg-danger text-center">{{$message}}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group col-md-3">
                                        ...
                                        <input name="emp_pasport_no" type="number" class="form-control" value="{{old('emp_pasport_no')}}">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input name="emp_pasport_from" type="text" class="form-control" value="{{old('emp_pasport_from')}}">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input name="emp_pasport_exp" type="date" class="form-control" value="{{old('emp_pasport_exp')}}">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input name="urgent_person_details" type="text" class="form-control" value="{{old('urgent_person_details')}}">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select name="is_Sensitive_manager_data" class="form-control select2 select2-hidden-accessible"  style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                    ...
                                    <option {{old("is_Sensitive_manager_data") == 2 ? 'selected' : ''}} value="2">لا</option>
                                </select>
                            ...
                            <div class="row col-md-12">
                                <div class="form-group col-md-4 r">
                                    ...
                                    <select name="emp_cv_ask" class="form-control select2 select2-hidden-accessible" id="emp_cv_ask" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                        <option {{old("emp_cv_ask") == 1 ? 'selected' : ''}} value="1">يوجد </option>
                                        <option {{old("emp_cv_ask") == 2 ? 'selected' : ''}} value="2">لا يوجد</option>
                                    </select>
                                    @error('emp_cv_ask')
                                    <div class="form-control bg-danger text-center">{{$message}}</div>
                                    @enderror
                                ...
                                <div class="form-group col-md-8" id="emp_cv">
                                    ...
                                    <input name="emp_cv" type="file" class="form-control" value="{{old('emp_cv')}}">
                                    @error('emp_cv')
                                    <div class="form-control bg-danger text-center">{{$message}}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row col-md-12">
                                <div class="form-group col-md-4">
                                    <label>هل لدي الموظف صورة هوية</label>
                                    <select name="emp_photo_ask" class="form-control select2 select2-hidden-accessible" id="emp_photo_ask" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                        <option {{old("emp_photo_ask") == 1 ? 'selected' : ''}} value="1">يوجد </option>
                                        <option {{old("emp_photo_ask") == 2 ? 'selected' : ''}} value="2">لا يوجد</option>
                                    </select>
                                    @error('emp_photo_ask')
                                    <div class="form-control bg-danger text-center">{{$message}}</div>
                                    @enderror
                                ...
                                <div class="form-group col-md-8" id="emp_photo">
                                    <label> صورة هوية الموظف</label>
                                    <input name="emp_photo" type="file" class="form-control" value="{{old('emp_photo')}}">
                                    @error('emp_photo')
                                    <div class="form-control bg-danger text-center">{{$message}}</div>
                                    @enderror
                                </div>
