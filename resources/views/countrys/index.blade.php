    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark"> دولة الموظف</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <a class="btn btn-outline-secondary col-12" href="{{route('countrys_add')}}">اضافة دولة جديدة</a>
                <div class="card card-gray">
                    ...
                    <div class="card">
                        <input type="text" id="search" name="name" class="form-control" placeholder="ابحث عن الدولة">
                            ...
                            <table class="table table-striped projects">
                                ...
                                <tr>
                                    ...
                                    <td class="project-state">
                                        @if($conn->active == 1)
                                        <span class="badge badge-success">دولة نشطة</span>
                                        @else
                                        <span class="badge badge-danger">دولة غير نشطة</span>
                                        @endif
                                    </td>
                                    <td class="project-actions text-center">
                                        <a class="btn btn-primary btn-sm isActive"  href="{{route('countrys_active',$conn->id)}}" >
                                            @if($conn->active == 1)
                                        ...
                                        <a class="btn btn-info btn-sm"  href="{{route('countrys_edit',$conn->name)}}">
                                            <i class="fas fa-pencil-alt"></i>
                                        </a>
                                        <a class="btn btn-danger btn-sm delete"  href="{{route('countrys_delete',$conn->id)}}">
