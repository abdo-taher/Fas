    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">تعديل الدولة </h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{route('index')}}">الرئسية</a></li>
                            <li class="breadcrumb-item"><a href="{{route('countrys')}}">دولة الموظفين</a></li>
                    ...
                    <div class="col-md-12 ">
                        <div class="card card-primary">
                            <div class="card-header">
                                ...
                                <h3 class="card-title ">تعديل دولة الموظفين</h3>
                            </div>
                            <form class="card-body" style="display: block;" action="{{route('countrys_editDone',$data->id)}}" method="post">
                                @csrf
