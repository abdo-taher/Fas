...
@section('military_services_edit')
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('military_services')}}">ترك العمل</a></li>
                ...
                <div class="row">
                    <div class="col-md-12 ">
                        <div class="card card-primary">
                            ...
                            <form class="card-body" style="display: block;" action="{{route('military_services_editDone',$data->id)}}" method="post">
                                @csrf
