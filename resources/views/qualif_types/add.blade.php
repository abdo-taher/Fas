            ...
            <div class="col-md-12 ">
                <div class="card card-primary">
                    <div class="card-header">
                        ...
                        <h3 class="card-title ">انواع المؤهلات</h3>
                    </div>
                    <form class="card-body" style="display: block;" action="{{route('qualif_types_addDone')}}" method="post">
                        @csrf
                        <div class="form-group">
                            <label>نوع المؤهل</label>
                            <input type="text" required name="name" class="form-control" placeholder="ادخل نوع المؤهل الدراسي">
                        </div>
                        @error('name')
